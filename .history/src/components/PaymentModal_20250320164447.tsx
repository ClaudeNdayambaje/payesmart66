...
interface PaymentModalProps {
  total: number;
  onClose: () => void;
  onPaymentComplete: (method: 'cash' | 'card', amountReceived: number, loyaltyCard?: LoyaltyCard) => void;
...
const PaymentModal: React.FC<PaymentModalProps> = ({
  ...
  const handleCardPayment = () => {
    onPaymentComplete('card', finalTotal, selectedLoyaltyCard);
  };
  ...
  useEffect(() => {
    const handleKeyPress = (e: KeyboardEvent) => {
      if (e.key === 'Escape') {
        ...
        onPaymentComplete('cash', parseFloat(cashReceived), selectedLoyaltyCard);
      }
    };
              ...
              <div className="space-y-6">
                ...
                {showChange && (
                  <div className="space-y-4">
                    ...
                    <button
                      onClick={() => onPaymentComplete('cash', parseFloat(cashReceived), selectedLoyaltyCard)}
