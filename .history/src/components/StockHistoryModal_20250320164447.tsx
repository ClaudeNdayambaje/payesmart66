...
import { X, ArrowUp, ArrowDown, Package, ShoppingCart, RotateCcw, AlertTriangle, ClipboardCheck } from 'lucide-react';
...
const StockHistoryModal: React.FC<StockHistoryModalProps> = ({
  ...
  const getMovementIcon = (type: StockMovement['type']) => {
    switch (type) {
      ...
      case 'reception':
        return <ArrowUp className="text-indigo-600" size={20} />;
      case 'loss':
      ...
      <div className="bg-white rounded-lg shadow-xl w-full max-w-2xl">
        ...
        <div className="p-4 max-h-[60vh] overflow-y-auto">
          <div className="space-y-4">
            ...
            {movements.filter(m => m.productId === product.id).length === 0 && (
