...
// Fonction pour charger Stripe uniquement quand nécessaire
let stripePromise: any = null;

export const getStripePromise = () => {
  if (!stripePromise) {
    // Charge Stripe uniquement lors du premier appel
    stripePromise = loadStripe("pk_test_51RO7WtQoGT4FIeuWEOxz1CVMVGcmHMefb91ErL1XFnapApuisZwhv0jIYbNby6c35jn5uayCLOWFZdne6gycC0Gv00gUOUpujK");
  }
